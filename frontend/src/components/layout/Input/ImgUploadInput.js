...
const ImgUploadInput = ({ handleChange, label }) => (
  <div className="w-full">
    ...
    <label className="flex flex-col items-center px-2 py-4 bg-gray-100 text-blue-500 rounded tracking-wide uppercase border border-gray-400 cursor-pointer hover:bg-blue-500 hover:text-blue-100 transition duration-75">
